...
public class FormDuyetHoaDonLe extends javax.swing.JFrame {
    ...
    public FormDuyetHoaDonLe(String SoHDL, String TenKH, Date NgayLap, String TongTien, ArrayList<ObjChiTietHDL> listGioHang) {
        ...
        for(int i =0;i<listGioHang.size();i++){
            Vector v =new Vector();
            ObjChiTietHDL ObjCTHDL = new ObjChiTietHDL(jtxtSoHDL.getText(),listGioHang.get(i).getMaSP(),listGioHang.get(i).getSoLuong(),listGioHang.get(i).getDonGia(),listGioHang.get(i).getThanhTien());
